...
- **What each key type leaves in memory is measured, not argued**
  ...
  once on a legacy build and once with `GOEXPERIMENT=runtimesecret`, against
  an empty allowlist.
